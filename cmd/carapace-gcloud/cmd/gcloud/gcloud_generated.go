...
func init() {
	services = map[string]string{
		...
		"apihub":                 "Manage Apihub resources.",
		...
		"beyondcorp":             "Manage Beyondcorp resources.",
		"biglake":                "Create and manage Google Cloud BigLake resources.",
		...
		"cluster-director":       "Manage Cluster Director resources.",
		"colab":                  "Manage Colab Enterprise resources.",
		"compliance-manager":     "Manage Compliance Manager resources.",
		...
		"datalineage":            "Manage Google Cloud Data Lineage resources.",
		...
		"design-center":          "Manage Application Design Center resources.",
		...
		"immersive-stream":       "*(REMOVED)*  Manage Immersive Stream resources.",
		...
		"quotas":                 "Manage Cloud Quotas quota info, quota preferences and quota adjuster settings.",
		...
		"service-health":         "Request events that are relevant to your project or organization.",
		...
		"support":                "Manage Support resources.",
		...
		"vector-search":          "Manage Vector Search data objects.",
